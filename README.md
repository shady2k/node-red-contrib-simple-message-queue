...
**bypass**: If a message is received with this property and set to True, queue will be cleared and stops the node from queueing new messages and just passes them through until an message with bypass property and False value is received.
